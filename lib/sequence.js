...
Sequence.prototype.skip = function drop(
  count : number = 1,
) : Sequence {
...
Sequence.prototype.skipWhile = function dropWhile(
 ...
 */
Sequence.prototype.map = function map(
  mapper : Mapper,
) : Sequence {
...
Sequence.prototype.yield = function take(
  count : number = 1,
) : Sequence {
...
Sequence.prototype.yieldWhile = function takeWhile(
