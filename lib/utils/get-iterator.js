 ...
 */
function getIndexBasedIterator(source : Array<any> | string) : IteratorLike {
  let index : number = -1;
 ...
 */
function getMapBasedIterator(source : Map<any, any>) : IteratorLike {
 ...
 */
function getSetBasedIterator(source : Set<any>) : IteratorLike {
 ...
 */
function getIteratorBasedIterator(source : Iterable<any>) : IteratorLike {
  let index : number = -1;
 ...
 * @return {IteratorLike}        an iterator that uses the keys in `source` to move.
 */
function getKeyBasedIterator(source : Object) : IteratorLike {
  let index : number = -1;
 ...
 * // logs 1, 2, 3, 4
 */
export default function getIterator(source : IterableObject) : IteratorLike {
  if (source != null) {
    ...
    } else if (typeof Symbol === 'function' && Symbol.iterator != null && source[Symbol.iterator] === 'function') {
