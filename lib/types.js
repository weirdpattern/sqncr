 ...
 */
export type IterableObject = Object | Iterable<any>;
...
/**
 * @callback DropCondition
 * @param  {*}               value  the value of the item being processed.
 * @param  {PropertyKey}     key    the key of the item being processed.
 * @param  {IterableObject}  source the original source of the item.
 * @return {NullableBoolean}       `true` to drop the item.
 */
...
/**
 * @callback TakeCondition
 * @param  {*}               value  the value of the item being processed.
 * @param  {PropertyKey}     key    the key of the item being processed.
 * @param  {IterableObject}  source the original source of the item.
 * @return {NullableBoolean}       `true` to take the item.
 */
export type TakeCondition = (
  value : any,
  key : PropertyKey,
  source : IterableObject
) => NullableBoolean;
